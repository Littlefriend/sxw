(function(ext) {
  ...
  var descriptor = function(){
    ...
    blocks = blocks.concat([
        ['w', 'connect to Mirobot: %s',                'connect', 'test.xiyouchen.com'],
    ...
    return {
      ...
      url: 'http://Littlefriend.github.io/sxw'
    };
  }


  function reloadExtension() {
    ScratchExtensions.unregister('Arduino Wifi Extension');
    ScratchExtensions.register('Arduino Wifi Extension', descriptor(), ext);
  }
